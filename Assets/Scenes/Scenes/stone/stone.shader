	...
	LOD 100
		...
		Pass
		{
			...
			fixed4 frag (V2FData i ) : SV_Target
			{
				...
				float3 hsvTorgb25 = HSVToRGB( float3(( WorldPosition.x * -0.04 ),1.64,1.64) );
				float3 ase_worldViewDir = UnityWorldSpaceViewDir(WorldPosition);
				ase_worldViewDir = normalize(ase_worldViewDir);
				float3 ase_worldNormal = i.ase_texcoord3.xyz;
				float3 _Vector1 = float3(0,0.01,12.57);
				...
				if( ( distance( WorldPosition , position36 ) + _Lightrange ) > Scale38 )
				ifLocalVar61 = _Vector2.x;
				else if( ( distance( WorldPosition , position36 ) + _Lightrange ) == Scale38 )
				...
				float3 break45 = ( WorldPosition * 1.96 );
				...
				finalColor = ( CLIP70 + ( ifLocalVar69 * _Color2 ) );
				return finalColor;
			}
			ENDCG
		}
...
/*ASEBEGIN
Version=18800
276;621.1429;1197.143;540.7143;640.6612;968.6343;1;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;78;-532.3054,-1213.349;Inherit;False;Constant;_Float10;Float 10;8;0;Create;True;0;0;0;False;0;False;-0.04;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector3Node;34;-1941.092,508.7397;Inherit;False;Global;ssss;ssss;3;0;Create;True;0;0;0;False;0;False;0,0,0;10.19696,10.19696,10.19696;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.RangedFloatNode;33;-41.63525,1236.923;Inherit;False;Constant;_Float3;Float 3;8;0;Create;True;0;0;0;False;0;False;1.96;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector3Node;31;-1945.571,310.9429;Inherit;False;Global;POS;POS;3;0;Create;True;0;0;0;False;0;False;0,0,0;997.2044,999.6988,1001.067;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.RangedFloatNode;37;25.21875,1337.848;Inherit;False;Constant;_Float9;Float 9;8;0;Create;True;0;0;0;False;0;False;0.08;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;77;-401.2423,-1342.972;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;26;-294.2033,-1092.825;Inherit;False;Constant;_Float2;Float 2;3;0;Create;True;0;0;0;False;0;False;1.64;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector3Node;23;-170.8218,-847.0412;Inherit;False;Constant;_Vector1;Vector 1;3;0;Create;True;0;0;0;False;0;False;0,0.01,12.57;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.ColorNode;29;2.396349,-1390.133;Inherit;False;Property;_Color0;Color 0;2;1;[HDR];Create;True;0;0;0;False;0;False;0,0,0,0;23.96863,5.332508,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;40;-409.4553,1052.309;Inherit;False;Property;_Float5;Float 5;6;0;Create;True;0;0;0;False;0;False;0;-0.2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;49;-1213.978,204.0177;Inherit;False;Property;_Lightrange;Lightrange;3;0;Create;True;0;0;0;False;0;False;0;0.7;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;54;463.4732,408.3848;Inherit;False;Property;_Vector3;Vector 3;4;0;Create;True;0;0;0;False;0;False;0,1;-0.7,-2.13;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.SamplerNode;1;-218.4287,-17.16231;Inherit;True;Property;_TextureSample0;Texture Sample 0;0;0;Create;True;0;0;0;False;0;False;-1;None;e713c08b269205c49b92e3e1d93c57ce;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;56;-1489.219,268.8667;Inherit;False;38;Scale;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.Vector3Node;57;-1088.462,422.1417;Inherit;False;Constant;_Vector2;Vector 2;2;0;Create;True;0;0;0;False;0;False;0,0,1;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RangedFloatNode;59;737.0226,1291.681;Inherit;False;Constant;_Float6;Float 6;6;0;Create;True;0;0;0;False;0;False;19.12;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;63;-466.8373,315.7607;Inherit;False;Constant;_Float4;Float 4;1;0;Create;True;0;0;0;False;0;False;0.99;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector3Node;66;786.4511,623.6387;Inherit;False;Constant;_Vector4;Vector 4;5;0;Create;True;0;0;0;False;0;False;0,0,1;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.RangedFloatNode;64;785.6414,531.5427;Inherit;False;Constant;_Float7;Float 7;5;0;Create;True;0;0;0;False;0;False;0.03;0.51;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;68;1240.424,582.9437;Inherit;False;Property;_Color2;Color 2;5;1;[HDR];Create;True;0;0;0;False;0;False;0,0,0,0;0,2.462395,4.237095,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;74;-1459.258,471.5957;Inherit;False;Property;_Float8;Float 8;7;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=DCB346262E2907651A391BD7CF127A15541A683A