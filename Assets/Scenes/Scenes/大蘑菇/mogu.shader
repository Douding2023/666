...
Shader "mogu"
{
	Properties
	{
		...
		_fresnal("fresnal", Vector) = (0,1,5,0)
	...
	LOD 100
		...
		Pass
		{
			...
			fixed4 frag (V2FData i ) : SV_Target
			{
				...
				float fresnelNode2 = ( _fresnal.x + _fresnal.y * pow( 1.0 - fresnelNdotV2, _fresnal.z ) );
				float mulTime16 = _Time.y * 0.54;
				float2 _Vector0 = float2(-3.95,-6.3);
				float time18 = _Vector0.x;
				float2 coords18 = WorldPosition.xy * _Vector0.y;
				float2 id18 = 0;
				float2 uv18 = 0;
				float voroi18 = voronoi18( coords18, time18, id18, uv18, 0 );
				float3 hsvTorgb12 = HSVToRGB( float3(( 0.41 * ( ( i.ase_texcoord3.xyz.z * 67.3 ) + mulTime16 + voroi18 ) ),1.07,1.07) );
				...
				float4 CLIP53 = ( tex2D( _basecolor, uv_basecolor ) + ( fresnelNode2 * float4( hsvTorgb12 , 0.0 ) * _Color0 ) );
...
/*ASEBEGIN
Version=18800
276;621.1429;1197.143;540.7143;2676.151;3304.691;1;True;True
Node;AmplifyShaderEditor.WorldPosInputsNode;11;-2491.056,-3123.427;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.PosVertexDataNode;72;-2437.764,-3336.182;Inherit;False;0;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;74;-2201.528,-3127.06;Inherit;False;Constant;_Float10;Float 10;11;0;Create;True;0;0;0;False;0;False;67.3;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector3Node;59;-3214.135,-1462.71;Inherit;False;Global;ssss;ssss;3;0;Create;True;0;0;0;False;0;False;0,0,0;2.469348,2.469348,2.469348;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.Vector3Node;58;-3218.614,-1652.889;Inherit;False;Global;POS;POS;3;0;Create;True;0;0;0;False;0;False;0,0,0;1.385,8.543,1.708;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;73;-2038.436,-3269.766;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleTimeNode;16;-2057.299,-2973.861;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;33;-1682.498,-919.1406;Inherit;False;Property;_Float4;Float 4;9;0;Create;True;0;0;0;False;0;False;0;0.44;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;64;-2487.021,-1767.432;Inherit;False;Property;_Lightrange;Lightrange;3;0;Create;True;0;0;0;False;0;False;0;1.24;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;1;-1576.429,-3775.138;Inherit;True;Property;_basecolor;basecolor;0;0;Create;True;0;0;0;False;0;False;-1;None;59fcabf469b8a7947b7d05ca59b31d92;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.Vector2Node;43;-809.5695,-1563.065;Inherit;False;Property;_Vector2;Vector 2;5;0;Create;True;0;0;0;False;0;False;0,1;-20.1,-32.04;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.ColorNode;51;-32.61841,-1388.506;Inherit;False;Property;_Color2;Color 2;7;1;[HDR];Create;True;0;0;0;False;0;False;0,0,0,0;0,3.525933,12.84447,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=F44BBC4173973DD48E6133245B0B810C0E3308C3